// Deterministisches Rauschen: Zufallsgenerator (mulberry32), 2D-Simplex, fbm, Hash.
...
export function hash2(x, y, seed = 0) {
  let h = Math.imul((x | 0) ^ 0x27d4eb2d, 0x165667b1) ^ Math.imul((y | 0) + seed * 374761393, 0x85ebca77);
...
// Grat-Rauschen (für Felsen)
export function ridged(noise, x, y, octaves = 3) {
