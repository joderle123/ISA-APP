  ...
  C.feed = [
    /* ================= Fakt oder Meinung? ================= */
    {
      ...
      items: [
        ...
        { von: 'skate_news24', text: '87 % aller Skater sagen: Der Park ist gefährlich.', fakt: false, fake: true, why: 'Die Zahl ist erfunden. Keiner weiß, wer gefragt wurde.' },
      ],
    },
    {
      id: 'fk02', type: 'fakt',
      ...
      items: [
        ...
        { von: 'food.fakten', text: 'Studien zeigen: Pizza macht in der Schule schlauer.', fakt: false, fake: true, why: '„Studien zeigen“ ohne echte Studie klingt nur nach Fakt.' },
      ],
    },
    {
      id: 'fk03', type: 'fakt',
      ...
      items: [
        ...
        { von: 'gratis.skins', text: 'Mit dem Update gibt es 5000 Gratis-Coins. Link in Bio!', fakt: false, fake: true, why: 'Ein Köder. Der Link will nur deine Daten.' },
      ],
    },
    {
      id: 'fk04', type: 'fakt',
      ...
      items: [
        ...
        { von: 'fouer.leaks', text: 'Dieses Jahr ist die Fouer für Schüler gratis.', fakt: false, fake: true, why: 'Steht nirgends offiziell. Einfach ausgedacht.' },
      ],
    },
    {
      id: 'fk05', type: 'fakt',
      ...
      items: [
        ...
        { von: 'audio.facts', text: 'Laut Test hält der Akku 300 Stunden.', fakt: false, fake: true, why: 'Kein Test genannt. Die Zahl kommt aus der Werbung.' },
      ],
    },
    {
      id: 'fk06', type: 'fakt',
      ...
      items: [
        ...
        { von: 'jobs.info.lu', text: 'Wer nicht kommt, bekommt keinen Praktikumsplatz.', fakt: false, fake: true, why: 'Klingt offiziell. Steht aber in keiner Einladung.' },
      ],
    },
    {
      id: 'fk07', type: 'fakt',
      ...
      items: [
        ...
        { von: 'sport.breaking', text: 'Der Kapitän von Portugal spielt heute im Tor.', fakt: false, fake: true, why: 'Kann man prüfen: Die Aufstellung sagt etwas anderes.' },
      ],
    },
    {
      id: 'fk08', type: 'fakt',
      ...
      items: [
        ...
        { von: 'deals.kirchberg', text: 'Die ersten 100 Leute bekommen ein Handy geschenkt.', fakt: false, fake: true, why: 'Ein erfundenes Angebot, damit alle teilen.' },
      ],
    },
    ...
    /* ================= Was machst du? ================= */
    {
      ...
      opts: [
        { t: 'Weiterleiten. Mia lacht doch sicher selbst.', p: 0, n: 380, feel: 8, line: 'Jetzt kennt die halbe Schule das Video. Mia will morgen nicht kommen.' },
        { t: 'In den Chat: „Kevin, du fällst doch selber dauernd.“', p: 1, n: 150, feel: 28, line: 'Kevin kontert. Jetzt streiten alle, und das Video wandert noch weiter.' },
        { t: 'In den Chat: „Löscht das. Nicht cool.“', p: 3, n: 30, feel: 62, line: 'Zwei andere schreiben „Stimmt“. Kevin löscht das Video.' },
        { t: 'Mia privat: „Soll ich wem Bescheid sagen?“', p: 3, n: 60, feel: 74, line: 'Mia fühlt sich nicht allein. Zusammen gehen sie zur Lehrerin.' },
      ],
    },
    {
      ...
      opts: [
        { t: 'Folgen. Nur um zu sehen, was noch kommt.', p: 0, n: 260, feel: 10, line: 'Mehr Follower, mehr Posts. Der Fake-Account wird immer größer.' },
        { t: 'Den Account bei Glimmr als Fake melden.', p: 2, n: 120, feel: 45, line: 'Gut! Glimmr prüft den Account. Das kann aber ein paar Tage dauern.' },
        { t: 'Screenshots machen, einer Lehrkraft zeigen.', p: 3, n: 45, feel: 72, line: 'Die Schule kümmert sich. Nach zwei Tagen ist der Account weg.' },
        { t: 'Kommentieren: „Wer das macht, ist erbärmlich!“', p: 1, n: 200, feel: 35, line: 'Der Account antwortet mit einem neuen Post. Diesmal über dich.' },
      ],
    },
    {
      ...
      opts: [
        { t: 'Daumen hoch. Ist doch nur ein neuer Chat.', p: 0, n: 18, feel: 8, line: 'Yara merkt es am nächsten Tag. Auf der Fahrt sitzt sie allein.' },
        { t: 'Nichts schreiben und einfach mitlesen.', p: 1, n: 12, feel: 28, line: 'Die neue Gruppe kommt trotzdem. Schweigen wirkt hier wie ein Ja.' },
        { t: 'Schreiben: „Nö. Redet lieber mit Yara.“', p: 3, n: 4, feel: 60, line: 'Zwei andere sagen auch Nein. Die Idee ist vom Tisch.' },
        { t: 'Yara fragen, ob sie im Bus neben dir sitzt.', p: 2, n: 12, feel: 70, line: 'Die Gruppe gibt es trotzdem. Aber Yara hat jemanden an ihrer Seite.' },
      ],
    },
    {
      ...
      opts: [
        ...
        { t: 'Rui schreiben: „Alles okay bei dir?“', p: 3, n: 150, feel: 70, line: 'Rui kann es erklären. Er merkt: Jemand hält zu ihm.' },
        { t: 'Den Post bei Glimmr als Mobbing melden.', p: 2, n: 160, feel: 45, line: 'Glimmr prüft den Post. Einige haben ihn aber schon gesehen.' },
        { t: 'Die Seite roasten: „Feiglinge ohne Namen!“', p: 1, n: 300, feel: 22, line: 'Die Seite postet noch mehr. Jetzt schauen doppelt so viele hin.' },
      ],
    },
    {
      ...
      opts: [
        { t: 'Mitlachen und ein paar Ideen geben.', p: 0, n: 310, feel: 8, line: 'Der Post geht online. Emir muss sich vor allen erklären.' },
        ...
        { t: 'Weggehen. Ist ja nicht mein Handy.', p: 1, n: 310, feel: 20, line: 'Du bist raus. Aber der Post geht trotzdem online.' },
      ],
    },
    {
      ...
      opts: [
        { t: 'Auch was Lustiges schreiben. Machen ja alle.', p: 0, n: 25, feel: 5, line: 'Noch ein fieser Kommentar mehr. Inês löscht ihr Video.' },
        { t: 'Einen netten Kommentar drunter schreiben.', p: 3, n: 6, feel: 68, line: 'Andere trauen sich jetzt auch. Plötzlich stehen da viele nette Kommentare.' },
        { t: 'Die fiesen Kommentare bei Glimmr melden.', p: 2, n: 3, feel: 52, line: 'Ein paar Kommentare werden gelöscht. Gute Sache.' },
        { t: 'Die Hater roasten: „Ihr tanzt noch schlechter!“', p: 1, n: 15, feel: 25, line: 'Die Hater schreiben zurück. Unter dem Clip tobt jetzt ein Streit.' },
      ],
    },
    {
      ...
      opts: [
        ...
        { t: 'Nichts sagen. Geht mich ja nichts an.', p: 1, n: 70, feel: 22, line: 'Der Screenshot bleibt im Chat. Jeder kann ihn weiterschicken.' },
      ],
    },
    {
      ...
      opts: [
        { t: 'Mitvoten. Ist doch nur eine Umfrage.', p: 0, n: 120, feel: 8, line: 'Milan ist auf Platz 1. Er tut so, als wäre es ihm egal.' },
        { t: 'Die Umfrage bei Glimmr melden.', p: 2, n: 60, feel: 45, line: 'Die Story verschwindet bald. Einige haben aber schon abgestimmt.' },
        { t: 'Kommentieren: „Voll daneben. Macht das weg.“', p: 3, n: 45, feel: 65, line: 'Andere schreiben das auch. Die Umfrage wird gelöscht.' },
        { t: 'Nicht abstimmen und weiterscrollen.', p: 1, n: 100, feel: 25, line: 'Du machst nicht mit. Aber die Umfrage läuft weiter.' },
      ],
    },
    {
      ...
      opts: [
        { t: 'Liken. Ist halt ein lustiges Foto.', p: 0, n: 80, feel: 8, line: 'Mehr Likes, mehr Kommentare. Sara zieht die Jacke nicht mehr an.' },
        { t: 'Kommentieren: „Coole Jacke. Lass sie in Ruhe.“', p: 3, n: 22, feel: 66, line: 'Andere stimmen zu. Emir löscht den Post.' },
        ...
        { t: 'Zurückroasten: „Emir, schau mal deine Schuhe an.“', p: 1, n: 50, feel: 25, line: 'Emir postet ein Foto von deinen Schuhen. Jetzt seid ihr zu zweit dran.' },
      ],
    },
    {
      ...
      opts: [
        ...
        { t: 'Schreiben: „Fake. Sowas kommt jedes Jahr.“', p: 3, n: 40, feel: 72, line: 'Tiago ist erleichtert. Die Kette endet hier.' },
        { t: 'Nicht weiterschicken, einfach löschen.', p: 2, n: 200, feel: 40, line: 'Bei dir endet die Kette. Die anderen haben aber noch Angst.' },
        { t: 'Kurz im Netz suchen, ob das stimmt.', p: 2, n: 120, feel: 50, line: 'Du findest raus: Fake. Gut geprüft! Jetzt noch der Gruppe sagen.' },
      ],
    },
    ...
    /* ================= Gruppendruck ================= */
    {
      ...
      opts: [
        { t: 'Nee, Krankenhaus ist nicht mein Plan. Döner?', k: 'cool', antwort: { von: 'Emir', text: 'Haha okay. Döner geht klar.' }, line: 'Klares Nein. Mit Humor. Und beim Döner bist du trotzdem dabei.' },
        ...
        { t: 'Kann heute nicht. Muss noch zu meiner Oma.', k: 'ausrede', antwort: { von: 'Emir', text: 'Dann machen wir es Samstag!' }, line: 'Heute bist du raus. Aber am Samstag kommt der Druck wieder.' },
        { t: 'Okay … aber nur kurz. Bin dabei.', k: 'ja', antwort: { von: 'Luca', text: 'Legende!' }, line: 'Du bist dabei. Aber willst du das wirklich? Das Risiko trägst du.' },
      ],
    ...
    },
    {
      ...
      opts: [
        { t: 'Morgen nicht. Aber Samstag Fouer? Bin dabei!', k: 'cool', antwort: { von: 'Lena', text: 'Samstag ist eh besser. Deal!' }, line: 'Nein zum Schwänzen. Ja zur Fouer. Das kommt gut an.' },
        { t: 'Ihr seid so kindisch. Macht das ohne mich.', k: 'hart', antwort: { von: 'Tiago', text: 'Uff. Dann halt nicht, Streber.' }, line: 'Dein Nein ist klar. Aber „kindisch“ kommt als Angriff an.' },
        { t: 'Mal sehen … ich schau morgen, wie es passt.', k: 'ausrede', antwort: { von: 'Tiago', text: 'Also ja! 8 Uhr an der Gare.' }, line: '„Mal sehen“ klingt wie Ja. Morgen wird Nein sagen schwerer.' },
        { t: 'Okay, ich komm mit. Einmal ist keinmal.', k: 'ja', antwort: { von: 'Lena', text: 'Nice!' }, line: 'Du bist dabei. Morgen gibt es wohl Ärger mit der Schule.' },
      ],
    ...
    },
    {
      ...
      opts: [
        ...
        { t: 'Ihh, eklig. Ihr seid doch alle süchtig.', k: 'hart', antwort: { von: 'Aylin', text: 'Okay, dann bleib halt weg.' }, line: 'Dein Nein ist klar. Aber jetzt ist die Stimmung im Keller.' },
        { t: 'Vielleicht später. Ich hab grad keine Lust.', k: 'ausrede', antwort: { von: 'Aylin', text: 'Okay, später dann!' }, line: '„Später“ heißt: Die Frage kommt garantiert wieder.' },
        { t: 'Okay, einmal ziehen. Was soll schon sein.', k: 'ja', antwort: { von: 'Kevin', text: 'Siehste, easy.' }, line: 'Einmal bleibt oft nicht einmal. Nikotin macht schnell abhängig.' },
      ],
    ...
    },
    {
      ...
      opts: [
        { t: 'Nee, ich lass mich nicht erwischen. Pizza?', k: 'cool', antwort: { von: 'Rui', text: 'Haha, Pizza ist eh besser.' }, line: 'Nein gesagt, Alternative gezeigt. So bleibt die Stimmung gut.' },
        { t: 'Ich bin doch nicht euer Dealer, Leute!', k: 'hart', antwort: { von: 'Jeff', text: 'Chill, war nur eine Frage.' }, line: 'Das Nein kommt an. Aber etwas zu laut.' },
        { t: 'Hab grad echt kein Geld dabei. Sorry.', k: 'ausrede', antwort: { von: 'Rui', text: 'Wir geben dir doch Geld!' }, line: 'Die Ausrede zieht nicht. Jetzt musst du doch Nein sagen.' },
        { t: 'Na gut, gebt her. Aber nur dieses Mal.', k: 'ja', antwort: { von: 'Jeff', text: 'Yes! Danke dir!' }, line: 'Wenn du erwischt wirst, hast du den Ärger. Nicht die anderen.' },
      ],
    ...
    },
    {
      ...
      opts: [
        { t: 'Nee, ich film keine Leute heimlich.', k: 'cool', antwort: { von: 'Sara', text: 'Hm. Stimmt eigentlich.' }, line: 'Nein mit Begründung. Das bringt die anderen zum Nachdenken.' },
        { t: 'Ihr seid so peinlich. Echt jetzt.', k: 'hart', antwort: { von: 'Milan', text: 'Und du bist langweilig.' }, line: 'Dein Nein ist klar. Aber jetzt geht es nur noch um Beleidigungen.' },
        { t: 'Geht nicht, mein Akku ist fast leer.', k: 'ausrede', antwort: { von: 'Milan', text: 'Dann nimm mein Handy!' }, line: 'Die Ausrede ist schnell weg. Jetzt stehst du wieder da.' },
        { t: 'Okay, ich film. Aber nur ganz kurz.', k: 'ja', antwort: { von: 'Sara', text: 'Yesss!' }, line: 'Heimlich filmen und posten ist nicht erlaubt. Das kann richtig Ärger geben.' },
      ],
    ...
    },
    {
      ...
      opts: [
        ...
        { t: 'Ihr seid voll die Mobber. Echt armselig.', k: 'hart', antwort: { von: 'Luca', text: 'Übertreib mal nicht.' }, line: 'Stimmt vielleicht. Aber so machen alle dicht.' },
        { t: 'Mir fällt grad echt nichts Gutes ein.', k: 'ausrede', antwort: { von: 'Luca', text: 'Dann schreib einfach „Loser“.' }, line: 'Die Ausrede hilft nicht. Jetzt hast du sogar einen Vorschlag bekommen.' },
        { t: 'Okay, ich schreib auch was Kleines.', k: 'ja', antwort: { von: 'Dylan', text: 'Haha, top!' }, line: 'Elias liest alles. Auch deinen Satz.' },
      ],
    ...
    },
    {
      ...
      opts: [
        { t: 'Nee, mein Herz bleibt heute normal. Pizza?', k: 'cool', antwort: { von: 'Emir', text: 'Haha, fair.' }, line: 'Nein mit Humor. Pizza gibt es trotzdem.' },
        { t: 'Voll dumm. Ihr kriegt noch einen Herzinfarkt.', k: 'hart', antwort: { von: 'Kevin', text: 'Oh Mann, Spaßbremse.' }, line: 'Dein Nein ist klar. Aber so hört dir keiner zu.' },
        { t: 'Heute nicht, ich hab echt Bauchweh.', k: 'ausrede', antwort: { von: 'Kevin', text: 'Dann nächste Woche!' }, line: 'Heute bist du raus. Nächste Woche kommt die Frage wieder.' },
        { t: 'Okay, her damit. Wird schon gehen.', k: 'ja', antwort: { von: 'Emir', text: 'Los geht es!' }, line: 'Nach Dose drei rast dein Herz. Dir wird richtig schlecht.' },
      ],
    ...
    },
    {
      ...
      opts: [
        { t: 'Mein Passwort kriegt nicht mal meine Katze.', k: 'cool', antwort: { von: 'Nora', text: 'Haha okay, verstehe.' }, line: 'Nein mit Witz. Dein Account bleibt deiner.' },
        { t: 'Hältst du mich für komplett blöd, oder was?', k: 'hart', antwort: { von: 'Nora', text: 'Wow. War nur nett gemeint.' }, line: 'Dein Account ist sicher. Aber Nora ist jetzt sauer.' },
        { t: 'Hab es vergessen. Echt, keine Ahnung mehr.', k: 'ausrede', antwort: { von: 'Nora', text: 'Dann setz es neu. Dauert eine Minute!' }, line: 'Die Ausrede ist schnell weg. Und Nora bleibt dran.' },
        { t: 'Okay, hier ist es. Aber sag es keinem.', k: 'ja', antwort: { von: 'Nora', text: 'Top! Warte kurz …' }, line: 'Jetzt kann jemand in deinem Namen posten. Ändere es schnell!' },
      ],
