/* Test-Helfer für SKILL DECK (Playwright, iPad-Größe).
   Aufruf eines Tests:  node skills/tests/<name>.mjs  (vorher: node skills/build.js) */
...
export const DIST = process.env.SK_DIST ? path.resolve(process.env.SK_DIST, 'index.html') : path.resolve(HERE, '..', 'dist', 'index.html');
export const SHOTS = process.env.SK_SHOTS || path.resolve(HERE, '..', '.shots');
